...
public class CombatActions2 : MonoBehaviour {
    ...
    void OnGUI() {
        if (Application.isEditor) {
            ...
            GUI.Label(new Rect(Screen.width/2, 16*0, 100, 100), "hasGun: "+hasGun.ToString());
            GUI.Label(new Rect(Screen.width / 2, 16*1, 100, 100), "hasHammer: "+hasHammer.ToString());
            GUI.Label(new Rect(Screen.width / 2, 16*2, 100, 100), "HasWeapon: "+HasWeapon().ToString());
            GUI.Label(new Rect(Screen.width / 2, 16*3, 100, 100), "charge: "+charge.ToString());
        }
    }
